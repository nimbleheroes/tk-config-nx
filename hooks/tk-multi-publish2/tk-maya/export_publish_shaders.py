...
class MayaSelectionSetShadersPublishPlugin(HookBaseClass):
    """
    Plugin for publishing a shader network from a selection set in an open maya session.

    This hook relies on functionality found in the base file publisher hook in
    the config and should inherit from it in the configuration. The hook
    setting for this plugin should look something like this::

        hook: "{config}/publish_file.py:{config}/tk-multi-publish2/{engine_name}/publish_sset_shaders.py"

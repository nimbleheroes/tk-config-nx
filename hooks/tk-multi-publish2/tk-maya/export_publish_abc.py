...
class ExportPublishAlembicPlugin(HookBaseClass):
    """
    Plugin for exporting alembic files from a maya session.

    This hook relies on functionality found in the base file publisher hook in
    the config and should inherit from it in the configuration. The hook
    setting for this plugin should look something like this:

        hook: "{config}/publish_file.py:{config}/tk-multi-publish2/{engine_name}/export_publish_alembic.py:{config}/tk-multi-publish2/{engine_name}/publish_sset_model.py"
    ...
    def description(self):
        ...
        description = """
            <p>This plugin exports alembic files from maya.</p>
            """

        return super(ExportPublishAlembicPlugin, self).description or description
    ...
    def settings(self):
        ...
        return super(ExportPublishAlembicPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        ["maya.*", "file.maya"]
        """
        return super(ExportPublishAlembicPlugin, self).item_filters or ["maya.*"]
    ...
    def publish(self, settings, item):
        ...
        super(ExportPublishAlembicPlugin, self).publish(settings, item)
